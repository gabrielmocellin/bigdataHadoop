...
public class transactionBrazilYear {
    public static void main(String[] args) throws Exception {
        ...
        Path outputFilePath = new Path("output/q5_resultado");

        // Criação do objeto Job com base na configuração criada anteriormente.
        Job hadoopMapReduceJob = Job.getInstance(hadoopConfig, "transactionBrazilYear");

        // Onde são definidas as classes usadas para esse Job
        hadoopMapReduceJob.setJarByClass(transactionBrazilYear.class);
