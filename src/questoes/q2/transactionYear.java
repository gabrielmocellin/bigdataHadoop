...
public class transactionYear {
    public static void main(String[] args) throws Exception {
        ...
        Path outputFilePath = new Path("output/q2_resultado");
        ...
        hadoopMapReduceJob.setJarByClass(transactionYear.class);
        hadoopMapReduceJob.setMapperClass(transactionYearMapper.class);
        hadoopMapReduceJob.setReducerClass(transactionYearReducer.class);
