...
public class transactionMaxMin {
    public static void main(String[] args) throws Exception {
        ...
        Path outputFilePath = new Path("output/q6_resultado");
        ...
        hadoopMapReduceJob.setJarByClass(transactionMaxMin.class);
        hadoopMapReduceJob.setMapperClass(transactionMaxMinMapper.class);
        hadoopMapReduceJob.setReducerClass(transactionMaxMinReduce.class);
