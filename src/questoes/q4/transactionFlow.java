...
public class transactionFlow {
    public static void main(String[] args) throws Exception {
        ...
        Path outputFilePath = new Path("output/q4_resultado");
        ...
        hadoopMapReduceJob.setJarByClass(transactionFlow.class);
        hadoopMapReduceJob.setMapperClass(transactionFlowMapper.class);
        hadoopMapReduceJob.setReducerClass(transactionFlowReducer.class);
